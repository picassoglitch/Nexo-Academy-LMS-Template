...
export const OrgMenu = (props: any) => {
  ...
  return (
    <>
      ...
      <div className="backdrop-blur-lg bg-[#0a0a0a]/95 fixed top-0 left-0 right-0 h-[60px] ring-1 ring-inset ring-white/5 shadow-[0px_4px_24px_rgba(0,0,0,0.5)] z-50">
      ...
      <div
        className={`fixed inset-x-0 z-40 bg-[#0a0a0a]/95 backdrop-blur-lg md:hidden border-b border-white/5 shadow-lg transition-all duration-300 ease-in-out ${
